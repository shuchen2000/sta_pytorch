...
class MFQEv2Dataset(data.Dataset):
    ...
    def __init__(self, opts_dict, radius):
        ...
        self.gt_root = op.join(
            '/home/shuchen/datasets/ScreenContent/',
        ...
        if radius == 0:
            ...
            self.neighbor_list = [i + 1 for i in range(radius)]
    ...
    def __getitem__(self, index):
        ...
        key = self.keys[index]
        # print("key",key)
        # print("self.neighbor_list",self.neighbor_list)
...
class MFQEv2Dubble(data.Dataset):
    """MFQEv2 dataset.
